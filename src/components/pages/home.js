      ...
      alanBtnInstance.current = alanBtn({
        ...
        onCommand: (commandData) => {
          if (commandData.command === "gotoFaq") {
            ...
            scroll.scrollTo(`MuiPaper-${commandData.qId}`, {
              duration: 800,
              delay: 0,
            ...
            window.open(
              "https://github.com/maheshlode/Doc-Chain-Chatbot",
              "_blank"
            );
          }
        },
        ...
        <div id="body">
            <div id="top">
                <div className="homeStyle">
                    ...
                    <div className="buttonStyle">
                        <a href="/verify"><button type="button" className="btn btn-danger text-white">Go Verify</button></a>
                        <a href="/upload"><button type="button" className="btn btn-success text-white" >Upload</button></a>
                    </div> */}
                    <Carousel/>
                </div>
            </div>
            ...
            {/* <div className="container-fluid" style={{ paddingTop: "2rem" }}>
                <div className="row text-light">
                    ...
                    <img src={Time} width="150" alt="fast process" className="image"/>
                        <h4>Instant Download</h4>
                        <p className="para-light">
                        Download your documents anytime, anywhere and print or use them as you need
                        </p>
                    </div>
                    <div className="col-lg-4 text-center">
                    <img src={Cost} width="150" alt="less cost" className="image"/>
                        <h4>Easy Sharing</h4>
                        <p className="para-light">
                        Share your documents with anyone, anytime, anywhere. No need for physical copies or visits.
                        </p>
                        
                    </div>
                    <div className="col-lg-4 text-center">
                        <img src={DocImage} width="150" alt="secure" className="image"/>
                        <h4>Secure Storage</h4>
                        <p className="para-light">
                        Your documents are stored securely in blockchain, encrypted and backed up regularly.  
                        </p>
                    </div>
                </div>
            </div> */}
<Cards/>
            ...
            <div className="container" id="about">
                ...
                <div className="row d-flex align-items-center">
                    ...
                    <div className="col-lg-5 text-center" style={{ color: "white" }}>
                    <img className="img-fluid" id="teamImage" src={Team} alt="about" />
                    </div>
