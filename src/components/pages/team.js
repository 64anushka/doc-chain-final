                ...
                <div className="row" style={{marginRight:"none"}}>
                    ...
                    <div className="col-sm-6 col-md-4">
                        ...
                        <div className="team-item">
                            ...
                            <img src={anushka} className="team-img" alt="pic" />
                            <h3>Anushka yadav</h3>
...
the team doing so. </p>
                            ...
                            <a href="https://www.linkedin.com/in/anushka-yadav-044714238/"><button className="btn btn-primary text-white" >LinkedIn</button></a>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-6 col-md-4">
                        ...
                        <div className="team-item">
                            ...
                            <img src={chetana} className="team-img" alt="pic" />
                            ...
                            <a href="https://www.linkedin.com/in/chetana-agarwal-a695b61b4/"><button className="btn btn-primary text-white" >LinkedIn</button></a>
                    ...
                    <div className="col-sm-6 col-md-4">
                        ...
                        <div className="team-item">
                            ...
                            <img src={mahesh} className="team-img" alt="pic" />
...
entry-level position in an organization that offers good growth prospects.</p>
                            ...
                            <a href="https://www.linkedin.com/in/mahesh-lode/"><button className="btn btn-primary text-white" >LinkedIn</button></a>
                        </div>
