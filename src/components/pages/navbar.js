...
function NavBar() {
    ...
    } else if (account == '0xbf2a196909ef5ffb9c297dac70a019135baff5ca' || account == '0x3e071ec1098f29964fec1593e6ca2fb748b07f38'||
     account == '0x32f26b3485bd52c3b024e76ffb41f5ed4c2b6ef8' || account == '0x93ab21d90da19efa2f7b13d5d4d8578307e0fac1' ) {
        navbarLinks = (
            <>
                <li className="nav-item">
            ...
            <nav className="navbar">
                <div className="nav-container">
                    <NavLink exact to="/home" className="nav-logo">
                        <p id="title">Doc<span id="chain">-Chain</span></p>
                    </NavLink>
                    <ul className={
